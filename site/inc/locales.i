...
?>
			...
			<li>
				...
				<ul>
				<li><a href="http://twitter.com/mibew"><img src="http://www.twitterbuttons.com/images/lbn/twitterbutton-0208.png" title="By: TwitterButtons.com" width="120" height="90" /></a></li>
				<li>
