...
c):f.call(a,"L10n","pending.table.speak",c)))+'"></div>\n        ')},d),data:d}))||0===a)b+=a;b+="\n        ";if((a=e["if"].call(c,c.canView,{hash:{},inverse:this.noop,fn:this.program(11,function(a,b){var c,g;c={hash:{},data:b};return c='\n            <div class="control view-control inline-block" title="'+(h((g=e.L10n,g?g.call(a,"pending.table.view",c):f.call(a,"L10n","pending.table.view",c)))+'"></div>\n        ')},d),data:d}))||0===a)b+=a;b+="\n        ";if((a=e["if"].call(c,c.tracked,{hash:{},
inverse:this.noop,fn:this.program(13,function(a,b){var c,g;c={hash:{},data:b};return c='\n            <div class="control track-control inline-block" title="'+(h((g=e.L10n,g?g.call(a,"pending.table.tracked",c):f.call(a,"L10n","pending.table.tracked",c)))+'"></div>\n        ')},d),data:d}))||0===a)b+=a;b+="\n        ";if((a=e["if"].call(c,c.canBan,{hash:{},inverse:this.noop,fn:this.program(15,function(a,b){var c,g;c={hash:{},data:b};return c='\n            <div class="control ban-control inline-block" title="'+
